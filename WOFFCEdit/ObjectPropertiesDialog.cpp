...
afx_msg LRESULT ObjectPropertiesDialog::OnPropertiesGridPropertyUpdated(WPARAM wParam, LPARAM lParam)
{
	...
	// Ideally this would be a switch statement but C++ is antique and doesnt allow for switch statements when looking up a dictionary.
		...
		currentSceneObject->one_shot = VARIANTBOOLToBool(currentProperty->GetValue().bVal);
	else if (propertyToDatabaseName[currentProperty] == "play_on_init")
		currentSceneObject->play_on_init = VARIANTBOOLToBool(currentProperty->GetValue().bVal);
	else if (propertyToDatabaseName[currentProperty] == "play_in_editor")
		currentSceneObject->play_in_editor = VARIANTBOOLToBool(currentProperty->GetValue().bVal);
		...
		currentSceneObject->camera = VARIANTBOOLToBool(currentProperty->GetValue().bVal);
	else if (propertyToDatabaseName[currentProperty] == "path_node")
		currentSceneObject->path_node = VARIANTBOOLToBool(currentProperty->GetValue().bVal);
	else if (propertyToDatabaseName[currentProperty] == "path_node_start")
		currentSceneObject->path_node_start = VARIANTBOOLToBool(currentProperty->GetValue().bVal);
	else if (propertyToDatabaseName[currentProperty] == "path_node_end")
		currentSceneObject->path_node_end = VARIANTBOOLToBool(currentProperty->GetValue().bVal);
		...
		currentSceneObject->editor_wireframe = VARIANTBOOLToBool(currentProperty->GetValue().bVal);
